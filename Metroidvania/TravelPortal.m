...
-(instancetype)initWithImage:(NSString *)name{
    ...
    if(self!=nil){
        ...
        _repeataction=[SKAction repeatActionForever:[SKAction animateWithTextures:repeatarray timePerFrame:0.15]];
        [self runAction:[SKAction sequence:@[_appearaction,_repeataction]]];
